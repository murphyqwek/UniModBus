...
{
    /// <summary>
    /// Класс для подсчета контрольной суммы команд
    /// </summary>
    public static class ModBusCRC
    {
        ...
        /// <summary>
        /// Метод для подсчета контрольной суммы команды
        /// </summary>
        /// <param name="command">Последовательность байт команды без контрольной суммы</param>
        /// <returns>Новый массив байтов, который содержит команду и контрольную сумму в конце массива</returns>
